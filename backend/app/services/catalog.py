...
TOPICS = [
    ...
    TopicOut(id="topic_linux_files_beginner", library="linux", name="Файлы и директории", slug="files-directories", difficulty="beginner"),
    ...
    TopicOut(id="topic_linux_permissions_intermediate", library="linux", name="Права и процессы", slug="permissions-processes", difficulty="intermediate"),
    ...
    TopicOut(id="topic_linux_logs_advanced", library="linux", name="Логи и журналы", slug="logs-journals", difficulty="advanced"),
    TopicOut(id="topic_git_basics_beginner", library="git", name="Git: базовый цикл", slug="git-basics", difficulty="beginner"),
    TopicOut(id="topic_git_diff_beginner", library="git", name="Git: diff и staging", slug="git-diff-staging", difficulty="beginner"),
    ...
    TopicOut(id="topic_git_conflicts_intermediate", library="git", name="Git: слияния и конфликты", slug="git-merge-conflicts", difficulty="intermediate"),
    ...
    TopicOut(id="topic_git_stash_bisect_advanced", library="git", name="Git: stash и bisect", slug="git-stash-bisect", difficulty="advanced"),
    TopicOut(id="topic_conda_basics_beginner", library="conda", name="Conda: основы", slug="conda-basics", difficulty="beginner"),
    TopicOut(id="topic_conda_packages_beginner", library="conda", name="Conda: поиск пакетов", slug="conda-package-search", difficulty="beginner"),
    ...
    TopicOut(id="topic_conda_channels_intermediate", library="conda", name="Conda: каналы и приоритеты", slug="conda-channels-priority", difficulty="intermediate"),
    ...
    TopicOut(id="topic_conda_troubleshooting_advanced", library="conda", name="Conda: диагностика окружений", slug="conda-troubleshooting", difficulty="advanced"),
    TopicOut(id="topic_docker_basics_beginner", library="docker", name="Docker: основы", slug="docker-basics", difficulty="beginner"),
    TopicOut(id="topic_docker_images_beginner", library="docker", name="Docker: образы", slug="docker-images", difficulty="beginner"),
    ...
    TopicOut(id="topic_docker_volumes_intermediate", library="docker", name="Docker: volumes и networks", slug="docker-volumes-networks", difficulty="intermediate"),
    ...
    TopicOut(id="topic_docker_prod_advanced", library="docker", name="Docker: production диагностика", slug="docker-production-diagnostics", difficulty="advanced"),
]
